...
// The username used for opening the session does not need to be SAS-specific, it can be used in your application elsewhere.
// The same applies for the login Activity. If your application already has one, just add the open(...) call at the proper place.
//
public class SpeechKitCustomSample extends Activity implements View.OnKeyListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_speechkit_customsample);
