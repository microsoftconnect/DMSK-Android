...
//
public class SpeechKitDocumentSample extends Activity implements View.OnKeyListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_speechkit_documentsample);
